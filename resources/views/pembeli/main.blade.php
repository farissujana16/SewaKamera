...
<body id="home">
    <div class="page-wrapper">
                    ...
                    <div class="header-right">
                      ...
                      <div class="dropdown cart-dropdown">
                          <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                              ...
                              <span class="cart-count">@yield('total')</span>
                          </a>
                      ...
                      <div class="dropdown cart-dropdown">
                          <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                              <i class="icon-user"></i>
                              <p style="font-family: Helvetica; font-weight: Bold;">{{ auth()->user()->name }}</p>
                          </a>
                          <div class="dropdown-menu dropdown-menu-right">
        ...
        <main class="main">
          ...
          <div class="page-header page-header-big text-center" style="background-image: url('{{ asset('pelanggan/images/alat.jpg') }}')">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6 offset-lg-1">
                              <div class="about-images">
                                  ...
                                  <img src="{{ asset('pelanggan/images/alat_2.jpg') }}" alt="" class="about-img-front">
                              </div><!-- End .about-images -->
                          </div><!-- End .col-lg-6 -->
                      </div><!-- End .row -->
                  </div><!-- End .container -->
              </div><!-- End .bg-light-2 pt-6 pb-6 -->
    		<div id="kategori" class="container categories pt-6">
