                    ...
                    @foreach( $cart as $barang )
											...
											<td class="product-col">
												<div class="product">
													<figure class="product-media">
															...
															<img src="{{ asset("pelanggan/images/products/$barang->foto") }}" alt="Product image">

													</figure>

													<h3 class="product-title">
                            <a href="{{ url("/keranjang/update/$barang->id_pesanan") }}">{{ $barang->nama_barang }}</a>
                        ...
                        <script type="text/javascript">
                          ...
                          document.write(numberWithCommas({{ $barang->harga_barang }}));
											...
											<td class="price-col">{{ $barang->banyak }}</td>
											<td class="total-col">
                        <script type="text/javascript">
                          function numberWithCommas(number)
                          {
                          ...
                          document.write(numberWithCommas({{ $barang->total }}));
                        </script>
                      </td>
                      <td class="price-col">{{ $barang->status }}</td>
                      <form class="" action="{{ url('/keranjang') }}" method="post">
                        @method('delete')
                        @csrf
                        <td class="remove-col">
                          <button class="btn-remove"><i class="icon-close"></i></button>
                          <input type="text" name="id_pesanan" value="{{ $barang->id_pesanan }}" hidden>
                        </td>
                      </form>
										</tr>
                    @endforeach
