                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">{{ $barang->nama_barang }}</h1><!-- End .product-title -->
                                    ...
                                    <form class="" action="{{ url('/keranjang') }}" method="post">
                                      ...
                                      <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="product-details-quantity">
                                          <input type="number" id="qty" class="form-control" value="{{ $cart->banyak }}" min="1" max="{{ $barang->stok_barang }}" step="1" data-decimals="0" name="banyak" required>
